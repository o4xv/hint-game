    ...
    <div className="practice" data-step={phase === "free" ? "free" : step}>
      ...
      <div className="practice-body">
        ...
        <details className="practice-tip">
          <summary>ما الفرق بين تغيير البطاقة وتغيير مكان الإجابة؟</summary>
          <p>
            <strong>تغيير البطاقة</strong> متاح مرة واحدة في دور الوسيط، ويستبدل المقياس دون خصم
            نقاط، ويبقى مكان الإجابة والوسيط والفريق والمؤقت كما هي.
          </p>
          <p>
            <strong>تغيير مكان الإجابة</strong> متاح مرة واحدة في الدور، وبحد أقصى ثلاث مرات للوسيط
            في الوضع الفردي أو للفريق النشط في وضع الفرق خلال المباراة كلها، وينقل الإجابة إلى موضع
            بعيد مع بقاء المقياس والمؤقت كما هما.
          </p>
          <p>
            يمكن استخدام التغييرين في الدور نفسه. أما انتهاء وقت التلميح فيخصم نقطة من الوسيط أو من
            الفريق النشط ثم ينتقل الدور إلى الوسيط التالي.
          </p>
        </details>
      </div>
